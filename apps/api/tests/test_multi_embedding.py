...
def test_get_vector_table_name_resolution() -> None:
    ...
    assert get_vector_table_name(1024) == "vector_records_1024"
...
async def test_search_similar_routes_to_1024_table() -> None:
    ...
    with patch("src.adapters.vector.vector_repository.tenant_session") as mock_tenant_session:
        ...
        assert "FROM vector_records_1024 vr" in query_text
