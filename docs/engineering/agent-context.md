...
* **[architecture.md](file:///Users/prateeksharma/Developer/retriever/docs/architecture.md) (Logical Architecture Plan):** Specifies bounded contexts,Ports & Adapters interfaces, and dependency directions.
...
| **Feature Development** | [core-platform.md](file:///Users/prateeksharma/Developer/retriever/docs/features/core-platform.md)<br>[system-design.md](file:///Users/prateeksharma/Developer/retriever/docs/implementation/system-design.md) | 1. Target domain folder (`domain/core/`) <br>2. Target Ports folder (`domain/abstractions/`) | Read feature spec and API contract $\rightarrow$ Find active Ports $\rightarrow$ Write domain rules first $\rightarrow$ Implement adapter. |
...
| **Infrastructure Work** | ADRs (`docs/decisions/`) | 1. Target adapter file (`adapters/`) <br>2. Deployment manifest (`infrastructure/`) | Check ADR constraints $\rightarrow$ Implement adapter matching Port parameters $\rightarrow$ Configure Docker/K8s deployment variables. |
